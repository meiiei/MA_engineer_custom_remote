...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "imu1");

    ros::NodeHandle nh;
    
    if(nh.getParam("imu1_pub/ma_engineer/port",_serial_port)
       && nh.getParam("imu1_pub/ma_engineer/topic",_topic_name)
    )
    {
    ...
    ros::Publisher imu_pub = nh.advertise<sensor_msgs::Imu>(_topic_name, 10);
